...
class About extends Component {
  render() {
    return (
      <div>
        <h1>About</h1>
        <img src="https://cdn2.bulbagarden.net/upload/thumb/4/4b/Pok%C3%A9dex_logo.png/250px-Pok%C3%A9dex_logo.png" alt="logo pokedex" />
